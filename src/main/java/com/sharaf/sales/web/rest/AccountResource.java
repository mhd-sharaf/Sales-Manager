...
import com.sharaf.sales.service.UserService;
import com.sharaf.sales.service.dto.PasswordChangeDTO;
import com.sharaf.sales.service.dto.UserDTO;
import com.sharaf.sales.web.rest.errors.*;
import com.sharaf.sales.web.rest.vm.KeyAndPasswordVM;
import com.sharaf.sales.web.rest.vm.ManagedUserVM;
import java.util.*;
...
public class AccountResource {
	...
	public void requestPasswordReset(@RequestBody String mail) {
		...
		if (user.isPresent()) {
			log.warn("Password reset request should be sent");
		} else {
